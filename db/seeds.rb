...
Power.delete_all
el = Power.create("type" => "Electric Only")
eg = Power.create("type" => "Electric & Gas")
go = Power.create("type" => "Gas Only")
hy = Power.create("type" => "Hybrid Gas/Electric")

Car.delete_all
cv = Car.create("make" => "Chevy", "model" => "Volt", "msrp" => 34185, "hp" => 149, "drive_type" => eg.type, "electric_range" => 38, "gas_range" => 342, "total_range" => 380, "hours_to_charge" => 4, "front_photo_url" => "http://media.ed.edmunds-media.com/chevrolet/volt/2014/evox/2014_chevrolet_volt_4dr-hatchback_base_fs_evox_1_500.jpg", "back_photo_url" => "http://media.ed.edmunds-media.com/chevrolet/volt/2014/evox/2014_chevrolet_volt_4dr-hatchback_base_rst_evox_1_500.jpg", "side_photo_url" => "http://media.ed.edmunds-media.com/chevrolet/volt/2014/evox/2014_chevrolet_volt_4dr-hatchback_base_pr_evox_1_500.jpg", "quarter_photo_url" => "http://media.ed.edmunds-media.com/chevrolet/volt/2014/evox/2014_chevrolet_volt_4dr-hatchback_base_fqh_evox_1_500.jpg")
nl = Car.create("make" => "Nissan", "model" => "Leaf", "msrp" => 28980, "hp" => 107, "drive_type" => el.type, "electric_range" => 84, "gas_range" => 0, "total_range" => 84, "hours_to_charge" => 5, "front_photo_url" => "http://media.ed.edmunds-media.com/nissan/leaf/2014/evox/2014_nissan_leaf_4dr-hatchback_s_fs_evox_1_500.jpg", "back_photo_url" => "http://media.ed.edmunds-media.com/nissan/leaf/2014/evox/2014_nissan_leaf_4dr-hatchback_s_rst_evox_1_500.jpg", "side_photo_url" => "http://media.ed.edmunds-media.com/nissan/leaf/2014/evox/2014_nissan_leaf_4dr-hatchback_s_pr_evox_1_500.jpg", "quarter_photo_url" => "http://media.ed.edmunds-media.com/nissan/leaf/2014/evox/2014_nissan_leaf_4dr-hatchback_s_fqh_evox_1_500.jpg")
tm = Car.create("make" => "Tesla", "model" => "Model S", "msrp" => 69570, "hp" => 362, "drive_type" => el.type, "electric_range" => 265, "gas_range" => 0, "total_range" => 265, "hours_to_charge" => 9, "front_photo_url" => "http://media.ed.edmunds-media.com/tesla/model-s/2013/evox/2013_tesla_model-s_sedan_performance_fs_evox_1_500.jpg", "back_photo_url" => "http://media.ed.edmunds-media.com/tesla/model-s/2013/evox/2013_tesla_model-s_sedan_performance_rst_evox_1_500.jpg", "side_photo_url" => "http://media.ed.edmunds-media.com/tesla/model-s/2013/evox/2013_tesla_model-s_sedan_performance_pr_evox_1_500.jpg", "quarter_photo_url" => "http://media.ed.edmunds-media.com/tesla/model-s/2013/evox/2013_tesla_model-s_sedan_performance_fqh_evox_1_500.jpg")
