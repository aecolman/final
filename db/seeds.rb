...
Trip.create("user_id" => jc.id, "day" => 7, "miles" => 109)
Trip.create("user_id" => be.id, "day" => 1, "miles" => 42)
Trip.create("user_id" => be.id, "day" => 2, "miles" => 312)
...
Trip.create("user_id" => ac.id, "day" => 1, "miles" => 11)
Trip.create("user_id" => ac.id, "day" => 2, "miles" => 91)
Trip.create("user_id" => ac.id, "day" => 3, "miles" => 32)
Trip.create("user_id" => ac.id, "day" => 4, "miles" => 284)
Trip.create("user_id" => ac.id, "day" => 5, "miles" => 0)
Trip.create("user_id" => ac.id, "day" => 6, "miles" => 45)
Trip.create("user_id" => ac.id, "day" => 7, "miles" => 19)
...
Review.create("car_id" => cv.id, "user_id" => ac.id, "comment" => "A car with a magnetic personality.")
Review.create("car_id" => nl.id, "user_id" => be.id, "comment" => "Drives like lightning.")
Review.create("car_id" => nl.id, "user_id" => ac.id, "comment" => "Fried my circuits.")
