...
Trip.create("user_id" => ac.id, "day" => 1, "miles" => nil)
Trip.create("user_id" => ac.id, "day" => 2, "miles" => nil)
Trip.create("user_id" => ac.id, "day" => 3, "miles" => nil)
Trip.create("user_id" => ac.id, "day" => 4, "miles" => nil)
Trip.create("user_id" => ac.id, "day" => 5, "miles" => nil)
Trip.create("user_id" => ac.id, "day" => 6, "miles" => nil)
Trip.create("user_id" => ac.id, "day" => 7, "miles" => nil)
