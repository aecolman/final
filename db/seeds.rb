...
Trip.create("user_id" => ac.id, "day" => 1, "miles" => 0)
Trip.create("user_id" => ac.id, "day" => 2, "miles" => 0)
Trip.create("user_id" => ac.id, "day" => 3, "miles" => 0)
Trip.create("user_id" => ac.id, "day" => 4, "miles" => 0)
Trip.create("user_id" => ac.id, "day" => 5, "miles" => 0)
Trip.create("user_id" => ac.id, "day" => 6, "miles" => 0)
Trip.create("user_id" => ac.id, "day" => 7, "miles" => 0)
